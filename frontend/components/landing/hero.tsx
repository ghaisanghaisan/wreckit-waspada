...
import { AnimateOnView, WriteOnText } from "@/components/motion";
    ...
    <section className="relative overflow-hidden bg-background py-20 sm:py-24">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-4 sm:px-6 lg:flex-row lg:items-center">
        <div className="flex-1 space-y-6">
          <WriteOnText
            text="The Eye that Never Sleeps"
            className="text-sm font-semibold uppercase tracking-[0.2em] text-primary"
            delay={0.2}
          />
          <AnimateOnView animation="fadeUp">
            <p className="inline-block text-4xl font-semibold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
              Autonomous Cyber Intelligence and AI-Driven Threat Detection
            </p>
          </AnimateOnView>
          <AnimateOnView animation="fadeUp" delay={0.2}>
            <p className="max-w-xl text-base text-muted-foreground sm:text-lg">
              Monitor the digital landscape with autonomous AI capable of
              identifying sentiment shifts, coordinated messaging, and
              information operations at scale.
            </p>
          </AnimateOnView>

          <AnimateOnView animation="slideInLeft" delay={0.2}>
